...
### A specific phrase-level analogue relevant to the mutation hypothesis — still not ancestry

A second bounded passage in the accessible Westermann reproduction materially sharpens the existing mutation hypothesis.

In Westermann's discussion of RAF Bomber Command operations in 1942, the surrounding text is about aircraft returning to England with flak damage versus fighter damage. Westermann then reports an Operational Research Section finding that **“up to 80 percent of flak casualties” occurred over the target area**, explaining this by the concentration of anti-aircraft guns around targets. The following discussion remains about Bomber Command aircraft and aircrew losses.

That phrase is much closer to the later viral wording than a bare numerical resemblance:
...
- a second bounded Westermann passage uses the phrase “up to 80 percent of flak casualties” in a 1942 RAF Bomber Command context. That is now a specific phrase-level analogue relevant to the mutation hypothesis for the later viral wording, but no transmission path to the 2025 claim has been established;
