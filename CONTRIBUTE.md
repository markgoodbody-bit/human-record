...
If THR actively asks you, as a competent living person, to provide information about yourself voluntarily, the [living-subject encounter boundary](LIVING_SUBJECTS.md) applies. You may answer, decline, say you do not know or remember, dispute the question, keep something private, limit an answer to verification rather than publication, or stop the voluntary interaction.
